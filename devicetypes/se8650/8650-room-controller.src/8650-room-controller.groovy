...
metadata {
	...
	definition (name: "8650 Room Controller", namespace: "SE8650", author: "Schneider Electric", ocfDeviceType: "oic.d.thermostat") {
		...
		fingerprint profileId: "0104", inClusters: "0000,0003,0201,0204,0405", outClusters: "0402,0405", manufacturer: "Viconics", model: "254-162", deviceJoinName: "VT8650" //Viconics VT8650
		fingerprint profileId: "0104", inClusters: "0000,0003,0201,0204,0405", outClusters: "0402,0405", manufacturer: "Schneider Electric", model: "254-163", deviceJoinName: "SE8650" //Schneider Electric SE8650		
...
def parseCalled(String description) {
	...
	if (description?.startsWith("read attr -")) {
        ...
        else if (descMap.cluster == "0201" && descMap.attrId == "0698") {

        	log.debug "GAMMA Fan Mode"

            def modeOrder =  fanModeOrder()
...
def pollCalled() {
    ...
    delayBetween([
                ...
                zigbee.readAttribute(0x405, 0x0000),	//Read relative humidity
...
def switchOccupancy() {
    ...
    delayBetween([
            ...
            zigbee.readAttribute(0x201, 0x0C50),    //Effective System Mode
...
def fanOnGamma() {
    ...
    modeNumber = 0
        ...
        delayBetween([
        	...
        	zigbee.writeAttribute(0x201, 0x698, 0x30, modeNumber ),

        	zigbee.readAttribute(0x201, 0x698),	//Read Fan Mode
...
def fanSmartGamma() {
    ...
    modeNumber = 2
        ...
        delayBetween([
        	...
        	zigbee.readAttribute(0x201, 0x698),	//Read Heat Setpoint
